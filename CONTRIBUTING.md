...
Thank you for your interest in `minkelite`, an open source project
administered by StrongLoop.

Contributing to `minkelite` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/minkelite)
